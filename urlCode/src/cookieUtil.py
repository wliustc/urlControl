...
class CookieUtil:
    ...
    def saveVCodeImg(self,uuid):
        imgurlStr = self.iniObj.getValue('codeImg','url')
        imgurl = imgurlStr + "?uuid="+uuid+"&yys="
    ...
    def getLoginCookie(self):
        ...
        username_ = self.iniObj.getValue('user','username')
        password_ = self.iniObj.getValue('user','password')
